...
/*   Updated: 2022/03/07 18:03:41 by flcarval         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../includes/push_swap.h"

static int	big_block(int size, t_number **alst_a, t_number **alst_b, char **cmd_tab);
static void	small_block(int piv, t_number **alst_a, t_number **alst_b, char **cmd_tab);
